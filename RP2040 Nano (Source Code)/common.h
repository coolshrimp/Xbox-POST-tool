...
#define PIN_SDA_XBOX 0       // Replace with correct GPIO for Xbox SDA
#define PIN_SCL_XBOX 1       // Replace with correct GPIO for Xbox SCL

#define SERIAL_BAUD 115200   // Standard baud rate

#define __FW_VERSION__ "1.0.0"
#define __BUILD_DATE__ "20250522"  // Replace with actual build date
